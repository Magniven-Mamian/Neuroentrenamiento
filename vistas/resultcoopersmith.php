...
$alumnos="SELECT * FROM usuarios NATURAL JOIN estudiante inner join coopersmith on (coopersmith.id_estudiante=estudiante.id_estudiante)";
...
<header>
  ...
  <div class="alert alert-info">
            <h2>Descargar Reportes en Excel de la encuesta coopersmith</h2>
  </div>
 <section>
            <table class="table">
                <tr class="bg-primary">
...
<a href="../reportes/reporteCoopersmith.php">descargar</a>
      <!---los js-->
