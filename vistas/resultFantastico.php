...
$alumnos="SELECT * FROM usuarios NATURAL JOIN estudiante inner join fantastico on (fantastico.id_estudiante=estudiante.id_estudiante)";
...
<a href="../reportes/reporteFantastico.php">Descargar</a>
      <!---los js-->
