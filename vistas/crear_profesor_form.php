			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					<div class="panel-body">
						<form  autocomplete="off" method="POST" role="form" onsubmit="return crearProfesor();">
                          ...
                          <div class="form-group">
							...
							<button type="submit" class="btn btn-success" id="crear_profesor"> Agregar</button>
						</form>
					</div>
				</div>
			</div>
...
<script type="text/javascript"> 
 function crearProfesor(){
  ...
  var datos='txtCedula='+cedula+'&txtNombre='+nombre+'&txtApellidos='+apellidos+'&txtGenero='+genero+'&txtFecha_nacimiento='+fecha_nacimiento+'&txtTelefono='+telefono+'&txtEmail='+correo+'&txtPassword='+password+'&txtProfesion='+profesion;

   $.ajax({

    type:'POST',
    url:'../funcionescrud/crear_profesor_logic.php',
    data:datos,
    success:function(res){
        ...
        alertify.confirm('Registro Usuario', 'Usuario ya existe', function(){ alert('Documento o correo ya existen'+res) }
                , function(){ alertify.error('Cerrar')});
       }
    }
