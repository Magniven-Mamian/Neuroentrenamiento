...
<div class="modal fade" id="modalactualizarEstado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-ms" role="document">
    <div class="modal-content  modal-lg">
      <div class="modal-header modal-lg">
        <h4 class="modal-title" id="myModalLabel"> Actualizar Estado Estudiante  </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <form autocomplete="off">
              ...
              <input type="text" name="txt_idestudiantes" class="form-control" required id="txt_idestudiantes" value="<?php if(isset($txt_idestudiantes)) echo $txt_idestudiantes; ?>" placeholder="ingrese id de Estudiante" hidden>
        ...
        <div class="modal-footer">     
        <input type="submit" id="actualizarEstadoestudiante" class="btn btn-primary" data-dismiss="modal" value="actualizar estado">
        </form>
      </div>
    </div>
  </div>
 ...
 <div id="buscarEstudiante" name="buscarEstudiante"></div>

  <div id="tablaEstudiantes" name="tablaEstudiantes"></div>
...
<!---los    <script src="../funcionesJavascript/funciones.js" ></script> js--> 
  ...
  $('#tablaEstudiantes').load('../componentes/tablaEstudiantes.php');
   $('#buscarEstudiante').load('../componentes/buscarEstudianteCedula.php');
...
<script type="text/javascript">
    $(document).ready(function(){
      $('#actualizarestudiante').click(function(){
       ...
       $('#actualizarEstadoestudiante').click(function(){
       actualizarEstado();
      });
