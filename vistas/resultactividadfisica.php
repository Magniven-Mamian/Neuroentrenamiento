...
$alumnos="SELECT * FROM usuarios NATURAL JOIN estudiante inner join actividad_fisica on (actividad_fisica.id_estudiante=estudiante.id_estudiante)";
...
<header>
  ...
  <div class="alert alert-info">
            <h2>Descargar Reportes en Excel de la encuesta Fantástico</h2>
  </div>
 <section>
            <table class="table">
                <tr class="bg-primary">
...
<a href="../reportes/reporteactividadfisica.php">Descargar</a>
      <!---los js-->
